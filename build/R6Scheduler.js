...
var R6Scheduler = /** @class */ (function () {
    function R6Scheduler(params) {
        ...
        this.locale = "pl-PL";
        this.numerOfDaysInCurrentMonth = Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["getDaysInMonth"])(this.currentDate);
    ...
    R6Scheduler.prototype._findGaps = function (dayNumber) {
        ...
        var gap = 0;
        if (dayNumber === 1) {
            if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isMonday"])(date)) {
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isTuesday"])(date)) {
                gap += 1;
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isWednesday"])(date)) {
                gap += 2;
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isThursday"])(date)) {
                gap += 3;
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isFriday"])(date)) {
                gap += 4;
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isSaturday"])(date)) {
                gap += 5;
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isSunday"])(date)) {
                gap += 6;
                return gap;
            }
        }
            ...
            if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isSunday"])(date)) {
                return gap;
            }
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isSaturday"])(date)) {
                gap += 1;
            ...
            else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isMonday"])(date)) {
                gap += 6;
                return gap;
            }
        }
